<h1 align="center">Hi 👋, I'm Jason Shen</h1>

<h3 align="center">
Full-stack developer from New Zealand focused on real-time communications, AI, and open-source software
</h3>
...
- 🇳🇿 Full-stack developer from New Zealand
- 🔭 Currently building [StreamCore](https://github.com/streamcoreai/streamcore-server), an open-source real-time media server for AI applications
- 🎙️ Interested in WebRTC, voice AI, telephony, and distributed systems
...
`WebRTC` · `Pion` · `mediasoup` · `SIP` · `WebSockets` · `NATS` · `PostgreSQL`

**AI and machine learning**

`Voice AI` · `STT` · `LLMs` · `TTS` · `Fine-tuning` · `Dataset generation`

**Applications and infrastructure**

`React Native` · `Node.js` · `Docker` · `Linux` · `Supabase`

## Current open-source project

### [StreamCore](https://github.com/streamcoreai/streamcore-server)

Real-time media infrastructure for building voice agents and other AI-powered applications.

[Live demo](https://streamcore.ai) ·
[GitHub](https://github.com/streamcoreai/streamcore-server) ·
